...
struct PullRequestCommand: AsyncParsableCommand {
	...
	var noFormattedCommitsErrorMessage: String =
		"No formatted commits. Learn more about [how to use Conventional Commits](https://github.com/DavidBrunow/swift-conventional-commit-parser/blob/main/README.md#tips-on-using-conventional-commits)"
